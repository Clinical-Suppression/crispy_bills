...
public sealed class BillListItem
{
	...
	public BillListItem(BillItem bill, string? amountDisplay = null, bool isSoon = false)
	{
		...
		if (bill.IsPaid)
		{
			StatusBadgeBackground = dark ? Color.FromArgb("#2A5C42") : Color.FromArgb("#B8E8CC");
			StatusBadgeTextColor = dark ? Color.FromArgb("#86EFAC") : Color.FromArgb("#15803D");
			CardRowBackground = dark ? Color.FromArgb("#1F4A35") : Color.FromArgb("#C4E8D4");
		...
		{
			StatusBadgeBackground = dark ? Color.FromArgb("#5C2A38") : Color.FromArgb("#FFCDCD");
			StatusBadgeTextColor = dark ? Color.FromArgb("#FCA5A5") : Color.FromArgb("#B91C1C");
			CardRowBackground = dark ? Color.FromArgb("#4A222E") : Color.FromArgb("#FFD5D5");
			PrimaryRowTextColor = dark ? Color.FromArgb("#F8FAFC") : Color.FromArgb("#0A0F1A");
			SecondaryRowTextColor = dark ? Color.FromArgb("#E2E8F0") : Color.FromArgb("#334155");
		}
		else if (IsSoon)
		{
			StatusBadgeBackground = dark ? Color.FromArgb("#5C4D24") : Color.FromArgb("#FFE8A8");
			StatusBadgeTextColor = dark ? Color.FromArgb("#FCD34D") : Color.FromArgb("#A16207");
			CardRowBackground = dark ? Color.FromArgb("#4A3F1C") : Color.FromArgb("#FFF0C0");
			PrimaryRowTextColor = dark ? Color.FromArgb("#F8FAFC") : Color.FromArgb("#0A0F1A");
			SecondaryRowTextColor = dark ? Color.FromArgb("#E2E8F0") : Color.FromArgb("#334155");
		}
		else
		{
			StatusBadgeBackground = dark ? Color.FromArgb("#284060") : Color.FromArgb("#C4DCFC");
			StatusBadgeTextColor = dark ? Color.FromArgb("#93C5FD") : Color.FromArgb("#1D4ED8");
			CardRowBackground = dark ? Color.FromArgb("#1E3550") : Color.FromArgb("#D2E6FF");
			PrimaryRowTextColor = dark ? Color.FromArgb("#F8FAFC") : Color.FromArgb("#0A0F1A");
			SecondaryRowTextColor = dark ? Color.FromArgb("#E2E8F0") : Color.FromArgb("#334155");
		}
	}
